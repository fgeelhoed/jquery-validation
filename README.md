...
[![Build Status](https://secure.travis-ci.org/fgeelhoed/jquery-validation.png)](http://travis-ci.org/fgeelhoed/jquery-validation)
[![devDependency Status](https://david-dm.org/fgeelhoed/jquery-validation/dev-status.png?theme=shields.io)](https://david-dm.org/fgeelhoed/jquery-validation#info=devDependencies)
